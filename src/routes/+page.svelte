  ...
  <div class="mb-8 rounded-lg bg-white p-6 shadow-md">
    ...
    >
      ...
      <div>
        <button
          type="submit"
          class="w-full rounded-md bg-blue-600 px-4 py-2 font-medium text-white hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:outline-none md:w-auto hover:cursor-pointer"
          disabled={isLoading}
        >
          検索
        </button>
